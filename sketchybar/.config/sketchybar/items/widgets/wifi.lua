...
wifiUp:subscribe("network_update", function(env)
	local upColor = (env.upload == "000 Bps") and settings.colors.subtext2 or settings.colors.pearch
	local downColor = (env.download == "000 Bps") and settings.colors.subtext2 or settings.colors.blue
